...
# Параметр <role> — намеренная точка расширения для следующих локальных профилей
# провижининга; не специализировать этот launcher под единственный текущий netbook.yml.
#
